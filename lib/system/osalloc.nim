...
when defined(nimAllocPagesViaMalloc):
  ...
  when defined(nimAllocPagesAligned):
    # Direct passthrough: c_malloc already returns page-aligned memory
    # (e.g. via --cprefix redirecting malloc to VirtualAlloc/mm_malloc).
